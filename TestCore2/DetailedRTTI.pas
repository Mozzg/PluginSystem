...
begin
  ...
  case CallingConvention of
    System.TypInfo.ccReg: ;// Default
    System.TypInfo.ccCdecl: c := 'cdecl';
    System.TypInfo.ccPascal: c := 'pascal';
    System.TypInfo.ccStdCall: c := 'stdcall';
    System.TypInfo.ccSafeCall: c := 'safecall';
  end;
